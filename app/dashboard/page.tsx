...
import { Home, Building, Settings, Menu, X, Save, Upload, Download, Search, Filter, AlertCircle, CheckCircle, Clock, LogOutIcon } from "lucide-react";
...
export default function DashboardWithMap() {
  ...
  const menuItems = [
    ...
    { name: "Halaman History", icon: <Clock size={20}/>, id: "history"},
    { name: "Logout", icon: <LogOutIcon size={20}/>, id: "logout"},
  ];
...
<nav className="sticky top-0 z-30 w-full bg-white shadow-lg border-b border-gray-100">
  <div className="flex items-center justify-between p-3 sm:p-4 max-w-7xl mx-auto">
    {/* Logo/Title Section - Lebih Rapi */}
    <div className="flex items-center gap-3 flex-1 min-w-0">
      {/* Icon untuk semua ukuran */}
      ...
      <div className="min-w-0 flex-1">
        <h1 className="-base sm:text-lg font-bold text-blue-800 truntextcate leading-tight">
          Gedung Dekanat
        </h1>
    ...
    {/* Desktop Navigation - Lebih Teratur */}
        ...
        >
          ...
          <span className="lg:hidden text-xs">
            {item.name === "Dashboard" ? "Home" : 
             ...
             item.name === "Halaman History" ? "History" : item.name}
          </span>
        </button>
      ))}
    </div>

    {/* Right Section - Gabungkan API Status & Menu Button */}
    <div className="flex items-center gap-2 ml-2">
      {/* API Status untuk semua ukuran, tapi posisi berbeda */}
      <div className="hidden sm:block">
        <ApiStatusIndicator />
      </div>
      
      {/* Mobile Menu Button dengan API Status inline */}
  ...
  {/* Mobile Menu Dropdown - Lebih Rapi */}
  {menuOpen && (
  ...
  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
    <div>
      ...
      <p className="text-sm text-gray-500 mt-1">
        ...
        {active === 'manajemen' && 'Kelola data ruangan dari database'}
        {active === 'history' && 'Riwayat pengecekan alat proteksi kebakaran'}
      </p>
    </div>
    
    <div className="flex items-center gap-2 self-end sm:self-center">
      {/* Hanya tampilkan API status di mobile (karena di desktop sudah di navbar) */}
      ...
      {active === "lantai" && (
        <div className="text-xs text-gray-500 bg-gray-100 px-3 py-2 rounded-lg">
          <span className="font-medium">Tips:</span> Klik ruangan untuk detail
        </div>
      )}
    </div>
  </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-blue-700">
                      <p>Total record: <span className="font-bold">8</span> data pengecekan alat proteksi kebakaran.</p>
                      <p className="mt-1">Status tekanan: <span className="text-green-600 font-medium">Normal/Baik</span>, <span className="text-yellow-600 font-medium">Rendah</span>, <span className="text-red-600 font-medium">Expired</span></p>
                    </div>
                  </div>
                </div>
              </div>
